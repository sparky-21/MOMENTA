...
public class FinanceController {
    ...
    private void load(){
        javafx.concurrent.Task<Object[]> t=new javafx.concurrent.Task<>(){
            @Override protected Object[] call(){return new Object[]{service.getExpenses(CURRENT_USER_ID),service.getIncome(CURRENT_USER_ID),service.expenseByCategory(CURRENT_USER_ID),service.totalIncome(CURRENT_USER_ID),service.totalExpenses(CURRENT_USER_ID),service.savingsRate(CURRENT_USER_ID)};}
        };
